...
# Modified: Caleb Lareau, Broad Institute. June 2017

# The following program will extract the top summits with a pad
# to create a basic fixed width peak set for QC. Assumes sorted input
# .bed file with the first three columns of the file
